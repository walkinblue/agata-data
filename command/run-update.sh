...
if [ -z $1 ] || [ $1 eq "agata-common-service" ]; then
...
if [ -z $1 ] || [ $1 eq "agata-shop-service" ]; then
...
if [ -z $1 ] || [ $1 eq "agata-workshop" ]; then
...
if [ -z $1 ] || [ $1 eq "agata-workshop-service" ]; then
